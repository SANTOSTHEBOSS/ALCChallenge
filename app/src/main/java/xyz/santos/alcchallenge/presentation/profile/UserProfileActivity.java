...
public class UserProfileActivity extends AppCompatActivity implements UserProfileContract.View {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        textGitHubLink = (TextView) findViewById(R.id.text_github_link);
    ...
    public void showUserProfile(User user) {
        ...
        textGitHubLink.setText(user.getHtmlUrl());
    ...
    private void showProfileElements() {
        textGitHubLink.setVisibility(View.VISIBLE);
    ...
    private void hideProfileElements() {
        ...
        textGitHubLink.setVisibility(View.GONE);
